...
class ONNXDetect:
    ...
    def __call__(self, image):
        ...
        image = image[numpy.newaxis, numpy.newaxis, ...]  # Add two new axes for batch and channel
        print(image.shape)
...
def test(args):
    # Load model
    model = ONNXDetect(args, onnx_path='/home1/data/vinhnguyen/Flag_detection/runs_demo_model_s_lpr_v3_320_gray/train/weights/best.onnx')

    frame = cv2.imread('/home1/data/congvu/RetinaFace/STN_dataset_2/0/images/lp_0.jpg')
    image = frame.copy()
    outputs = model(image)
